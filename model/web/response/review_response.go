...
type ReviewResponse struct {
	...
	Image     string    `json:"image" example:"image url" extensions:"x-order=5"`
...
type FindReviewResponse struct {
	...
	Image     string             `json:"image" example:"image url" extensions:"x-order=3"`
	Car       CarResponse        `json:"car" extensions:"x-order=4"`
